...
var helpRegistry = []helpEntry{
	...
	{Topic: "Set Edge option", Command: "set edge <mode|upstream|port-forward> ...", Description: "Stage one Edge mode, upstream, or port-forward setting.", Workspaces: []workspace{workspaceMain}, Category: "Main", Group: "Setup"},
	...
	{Topic: "Stop Edge", Command: "stop edge", Description: "Stop Edge, finalize its evidence, and retry owned route, DHCP, PF, and adapter restoration.", Workspaces: []workspace{workspaceMain, workspaceNetwork}, Category: "Network", Group: "Runtime"},
